...
df = load_data_pandas("hpforestnaaerdetnokkkk_VALIDATE.csv")  #Here you have to put the name of your csv file which should include the actualtime, predicted time and (actual-predicted)
df = df.values.tolist()
diff_time = []
act_time =[]
pred_time = []
